! function(e, t) {
	...
	function B(e, t, n) {
		...
		return $(l, c), ut.isFunction(l.opts.start) && l.opts.start.call(e, l), ut.fx.timer(ut.extend(u, {
			elem: e,
			anim: l,
			queue: l.opts.queue
	...
	function R(e, t, n) {
		...
		if (o = m.length) {
			s = ut._data(e, "fxshow") || ut._data(e, "fxshow", {}), "hidden" in s && (g = s.hidden), u && (s.hidden = !g), g ? ut(e).show() : p.done(function() {
				ut(e).hide()
			}), p.done(function() {
				var t;
	...
	ut.fn = ut.prototype = {
		...
		noConflict: function(t) {
			return e.$ === ut && (e.$ = G), t && e.jQuery === ut && (e.jQuery = Q), ut
		},
		isReady: !1,
		readyWait: 1,
		...
		parseJSON: function(t) {
			try {
				if (e && e.JSON && e.JSON.parse) return e.JSON.parse(t)
			} catch (n) {}
			return null === t ? t : "string" == typeof t && (t = ut.trim(t), t && ht.test(t.replace(gt, "@").replace(yt, "]").replace(mt, ""))) ? new Function("return " + t)() : (ut.error("Invalid JSON: " + t), void 0)
		},
		parseXML: function(n) {
			var r, i;
	...
	ut.fn.extend({
		...
		removeAttr: function(e, t) {
			var n, r, i = 0,
				o = t && t.match(ct);
			if (o && 1 === e.nodeType)
				for (; n = o[i++];) r = ut.propFix[n] || n, Ht.test(n) ? !_t && Mt.test(n) ? e[ut.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : ut.attr(e, n, ""), e.removeAttribute(_t ? n : r)
		},
		attrHooks: {
			type: {
				set: function(e, t) {
		...
		get: function(e, n) {
			var r = ut.prop(e, n),
				...
				o = "boolean" == typeof r ? qt && _t ? null != i : Mt.test(n) ? e[ut.camelCase("default-" + n)] : !!i : e.getAttributeNode(n);
			return o && o.value !== !1 ? n.toLowerCase() : t
		},
		set: function(e, t, n) {
			return t === !1 ? ut.removeAttr(e, n) : qt && _t || !Mt.test(n) ? e.setAttribute(!_t && ut.propFix[n] || n, n) : e[ut.camelCase("default-" + n)] = e[n] = !0, n
		}
	}, qt && _t || (ut.attrHooks.value = {
		get: function(e, n) {
	...
	ut.event = {
			...
			add: function(e, n, r, i, o) {
				...
				if (y) {
					for (r.handler && (l = r, r = l.handler, o = l.selector), r.guid || (r.guid = ut.guid++), (s = y.events) || (s = y.events = {}), (f = y.handle) || (f = y.handle = function(e) {
						...
						}, f.elem = e), n = (n || "").match(ct) || [""], u = n.length; u--;) a = Pt.exec(n[u]) || [], h = g = a[1], m = (a[2] || "").split(".").sort(), c = ut.event.special[h] || {}, h = (o ? c.delegateType : c.bindType) || h, c = ut.event.special[h] || {}, p = ut.extend({
						type: h,
						origType: g,
						data: i,
						handler: r,
						...
						namespace: m.join(".")
					}, l), (d = s[h]) || (d = s[h] = [], d.delegateCount = 0, c.setup && c.setup.call(e, i, m, f) !== !1 || (e.addEventListener ? e.addEventListener(h, f, !1) : e.attachEvent && e.attachEvent("on" + h, f))), c.add && (c.add.call(e, p), p.handler.guid || (p.handler.guid = r.guid)), o ? d.splice(d.delegateCount++, 0, p) : d.push(p), ut.event.global[h] = !0;
					e = null
				}
			},
			remove: function(e, t, n, r, i) {
				...
				if (g && (c = g.events)) {
					for (t = (t || "").match(ct) || [""], l = t.length; l--;)
						if (s = Pt.exec(t[l]) || [], d = m = s[1], h = (s[2] || "").split(".").sort(), d) {
							for (f = ut.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = c[d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = p.length; o--;) a = p[o], !i && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (p.splice(o, 1), a.selector && p.delegateCount--, f.remove && f.remove.call(e, a));
			...
			trigger: function(n, r, i, o) {
				...
				if (u = f = i = i || Y, 3 !== i.nodeType && 8 !== i.nodeType && !Bt.test(h + ut.event.triggered) && (h.indexOf(".") >= 0 && (m = h.split("."), h = m.shift(), m.sort()), s = h.indexOf(":") < 0 && "on" + h, n = n[ut.expando] ? n : new ut.Event(h, "object" == typeof n && n), n.isTrigger = !0, n.namespace = m.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : ut.makeArray(r, [n]), c = ut.event.special[h] || {}, o || !c.trigger || c.trigger.apply(i, r) !== !1)) {
			...
			fix: function(e) {
				...
				var t, n, r, i = e.type,
					o = e,
					a = this.fixHooks[i];
				for (a || (this.fixHooks[i] = a = $t.test(i) ? this.mouseHooks : Ot.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ut.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
		...
		function(e, t) {
				...
				if (!M && !r) {
					if (i = mt.exec(e))
						if (a = i[1]) {
							...
							if ((a = i[3]) && R.getByClassName && t.getElementsByClassName) return G.apply(n, K.call(t.getElementsByClassName(a), 0)), n
						}
					if (R.qsa && !_.test(e)) {
						if (c = !0, d = B, h = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
						...
						if (m) try {
							return G.apply(n, K.call(h.querySelectorAll(m), 0)), n
						} catch (g) {} finally {
			...
			function g(e, t, n, r, o, a) {
				return r && !r[B] && (r = g(r)), o && !o[B] && (o = g(o, a)), i(function(i, a, s, u) {
					var l, c, f, p = [],
						d = [],
						h = a.length,
					...
					} else v = m(v === a ? v.splice(h, v.length) : v), o ? o(null, a, v, u) : G.apply(a, v)
				})
			}
				...
				var n = 0,
					...
					s = function(i, s, u, l, c) {
						...
						if (g += y, r && y !== g) {
							...
							if (i) {
								if (g > 0)
									for (; y--;) v[y] || h[y] || (h[y] = Q.call(l));
								h = m(h)
							}
							G.apply(l, h), b && !i && h.length > 0 && g + t.length > 1 && a.uniqueSort(l)
						}
						return b && (W = T, j = x), v
					};
				return r ? i(s) : s
			...
			function w() {}
			var T, N, C, k, E, S, A, j, D, L, H, M, _, q, F, O, $, B = "sizzle" + -new Date,
				P = e.document,
				R = {},
				W = 0,
				I = 0,
			...
			E = a.isXML = function(e) {
				...
				return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = r.documentElement, M = E(r), R.tagNameNoComments = o(function(e) {
					...
					return R.getIdNotName = !r.getElementById(B), H.removeChild(e), t
				...
				}, q = [], _ = [":focus"], (R.qsa = n(r.querySelectorAll)) && (o(function(e) {
					e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || _.push("\\[" + et + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"), e.querySelectorAll(":checked").length || _.push(":checked")
				}), o(function(e) {
					e.innerHTML = "<input type='hidden' i=''/>", e.querySelectorAll("[i^='']").length && _.push("[*^$]=" + et + "*(?:\"\"|'')"), e.querySelectorAll(":enabled").length || _.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), _.push(",.*:")
					...
					R.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), q.push("!=", ot)
				}), _ = new RegExp(_.join("|")), q = new RegExp(q.join("|")), O = n(H.contains) || H.compareDocumentPosition ? function(e, t) {
				...
				}, A = !1, [0, 0].sort($), R.detectDuplicates = A, L) : L
			}, a.matches = function(e, t) {
				return a(e, null, null, t)
			}, a.matchesSelector = function(e, t) {
				if ((e.ownerDocument || e) !== L && D(e), t = t.replace(bt, "='$1']"), !(!R.matchesSelector || M || q && q.test(t) || _.test(t))) try {
					var n = F.call(e, t);
				...
				var n;
				return (e.ownerDocument || e) !== L && D(e), M || (t = t.toLowerCase()), (n = C.attrHandle[t]) ? n(e) : M || R.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
			}, a.error = function(e) {
				...
				var t, n = [],
					r = 1,
					i = 0;
				if (A = !R.detectDuplicates, e.sort($), A) {
						...
						return 1 === r && 0 === i ? function(e) {
							...
							if (g) {
								...
								if (h = [a ? g.firstChild : g.lastChild], a && v) {
									for (c = g[B] || (g[B] = {}), l = c[e] || [], d = l[0] === W && l[1], p = l[0] === W && l[2], f = d && g.childNodes[d]; f = ++d && f && f[m] || (p = d = 0) || h.pop();)
										if (1 === f.nodeType && ++p && f === t) {
											c[e] = [W, d, p];
											break
										}
								} else if (v && (l = (t[B] || (t[B] = {}))[e]) && l[0] === W) p = l[1];
								else
									for (;
										(f = ++d && f && f[m] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++p || (v && ((f[B] || (f[B] = {}))[e] = [W, p]), f !== t)););
	...
	ut.fn.extend({
		...
		ut.fn[e] = function(n, r) {
			...
			return Rt.test(e) || (r = n), r && "string" == typeof r && (i = ut.filter(r, i)), i = this.length > 1 && !Xt[e] ? ut.unique(i) : i, this.length > 1 && Wt.test(e) && (i = i.reverse()), this.pushStack(i)
		}
	}), ut.extend({
	...
	sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td, ut.fn.extend({
		...
		html: function(e) {
			return ut.access(this, function(e) {
				...
				if (!("string" != typeof e || en.test(e) || !ut.support.htmlSerialize && Yt.test(e) || !ut.support.leadingWhitespace && Jt.test(e) || sn[(Gt.exec(e) || ["", ""])[1].toLowerCase()])) {
					e = e.replace(Qt, "<$1></$2>");
					try {
		...
		domManip: function(e, n, r) {
			...
			if (f && (l = ut.buildFragment(e, this[0].ownerDocument, !1, this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
				for (n = n && ut.nodeName(i, "tr"), s = ut.map(b(l, "script"), h), a = s.length; f > c; c++) o = l, c !== g && (o = ut.clone(o, !0, !0), a && ut.merge(s, b(o, "script"))), r.call(n && ut.nodeName(this[c], "table") ? d(this[c], "tbody") : this[c], o, c);
				if (a)
					for (u = s[s.length - 1].ownerDocument, ut.map(s, m), c = 0; a > c; c++) o = s[c], rn.test(o.type || "") && !ut._data(o, "globalEval") && ut.contains(u, o) && (o.src ? ut.ajax({
						url: o.src,
						type: "GET",
						dataType: "script",
						async: !1,
		...
		buildFragment: function(e, t, n, r) {
			for (var i, o, a, s, u, l, c, f = e.length, d = p(t), h = [], m = 0; f > m; m++)
				if (o = e[m], o || 0 === o)
					if ("object" === ut.type(o)) ut.merge(h, o.nodeType ? [o] : o);
					else if (Zt.test(o)) {
				for (s = s || d.appendChild(t.createElement("div")), u = (Gt.exec(o) || ["", ""])[1].toLowerCase(), c = sn[u] || sn._default, s.innerHTML = c[1] + o.replace(Qt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
			...
			for (s && d.removeChild(s), ut.support.appendChecked || ut.grep(b(h, "input"), x), m = 0; o = h[m++];)
				if ((!r || -1 === ut.inArray(o, r)) && (a = ut.contains(o.ownerDocument, o), s = b(d.appendChild(o), "script"), a && g(s), n))
	...
	Ln = Rn.exec(Hn.toLowerCase()) || [], ut.fn.load = function(e, n, r) {
		...
		ajax: function(e, n) {
			...
			if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || Hn) + "").replace(qn, "").replace(Pn, Ln[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = ut.trim(p.dataType || "*").toLowerCase().match(ct) || [""], null == p.crossDomain && (i = Rn.exec(p.url.toLowerCase()), p.crossDomain = !(!i || i[1] === Ln[1] && i[2] === Ln[2] && (i[3] || ("http:" === i[1] ? 80 : 443)) == (Ln[3] || ("http:" === Ln[1] ? 80 : 443)))), p.data && p.processData && "string" != typeof p.data && (p.data = ut.param(p.data, p.traditional)), L(In, p, n, T), 2 === x) return T;
			l = p.global, l && 0 === ut.active++ && ut.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Bn.test(p.type), a = p.url, p.hasContent || (p.data && (a = p.url += (_n.test(a) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = Fn.test(a) ? a.replace(Fn, "$1_=" + Mn++) : a + (_n.test(a) ? "&" : "?") + "_=" + Mn++)), p.ifModified && (ut.lastModified[a] && T.setRequestHeader("If-Modified-Since", ut.lastModified[a]), ut.etag[a] && T.setRequestHeader("If-None-Match", ut.etag[a])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Xn + "; q=0.01" : "") : p.accepts["*"]);
	...
	ut.ajaxSetup({
		...
		jsonpCallback: function() {
			var e = ut.expando + "_" + Mn++;
			return Vn.pop(), this[e] = !0, e
		}
		...
		return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = ut.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(Yn, "$1" + o) : n.jsonp !== !1 && (n.url += (_n.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
	...
	} : q, Qn = ut.ajaxSettings.xhr(), ut.support.cors = !!Qn && "withCredentials" in Qn, Qn = ut.support.ajax = !!Qn, Qn && ut.ajaxTransport(function(n) {
			...
			return {
				send: function(i, o) {
					...
					u.send(n.hasContent && n.data || null), r = function(e, i) {
						...
						f && o(s, c, f, l)
					}, n.async ? 4 === u.readyState ? setTimeout(r) : (a = ++Gn, Kn && (Jn || (Jn = {}, ut(e).unload(Kn)), Jn[a] = r), u.onreadystatechange = r) : r()
				},
				abort: function() {
					r && r(t, !0)
				}
	...
	ut.Animation = ut.extend(B, {
		...
		run: function(e) {
			...
			return this.pos = t = this.options.duration ? ut.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : W.propHooks._default.set(this), this
		}
